...
// Generic normalize helpers (toSnakeCase, normalizeKeys, parseMetadataJson,
// normalizeDateString, normalizeOptionalDateString, normalizeStringArray,
// normalizeNumber, normalizeBoolean) now live in the kit; re-export the ones
// other modules import from here so call sites stay unchanged.
export {
  normalizeKeys,
  normalizeOptionalDateString,
  parseMetadataJson,
